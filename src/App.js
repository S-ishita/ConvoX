import './App.css';
import convoLogo from './assets/convo.svg';
...
import convoImgLogo from './assets/convoLogo.svg';
    ...
    <div className="App">
      <div className="sideBar">
        <div className="upperSide">
          <div className="upperSideTop"><img src={convoLogo} alt="Logo" className="logo" /><span className="brand">ConvoX</span></div>
      ...
      <div className="main">
        <div className="chats">
          ...
          {messages.map((message, i) =>
            <div key={i} className={message.isBot ? "chat bot" : "chat"}>
              <img className="chatImg" src={message.isBot ? convoImgLogo : userIcon} alt="" /><p className="txt">{message.text}</p>
            </div>
          )}
          <div ref={msgEnd} />
        </div>
        <div className="chatFooter">
          ...
          <p>ConvoX may produce incorrect results and information about people,places or facts.ConvoX January 24 Version.</p>
        </div>
      </div>
    </div>
  );
